...
def main():
    ...
    parser.add_argument(
        "--images",
        type=str,
        help="Directory consisting of training and validation images."
    )
    parser.add_argument(
        "--train_labels",
        type=str,
    ...
    train_dataset = ChestXray14MultilabelDataset(args.images, args.train_labels)
    eval_dataset = ChestXray14MultilabelDataset(args.images, args.dev_labels)
