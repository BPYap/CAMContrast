...
from camcontrast.model import AVAILABLE_BACKBONES, AVAILABLE_BACKBONES_SEGMENTATION
...
def get_argument_parser(segmentation=False, finetune=False, distributed=False):
    ...
    if segmentation:
        parser.add_argument(
            ...
            type=str,
            default='u-net',
            help="Name of the segmentation architecture. Available options: ['u-net']."
        )
